...
class TextBasedChannel {
  ...
  send(content, options) {
    ...
    if (options && options._apiTransform && typeof options._apiTransform() !== "string") options = { embed: options };
    else if(options && options._apiTransform)content = options._apiTransform(), options = {}
    options.reply = reply;
  ...
  /**
   * Marque tous les message du salon comme lu.
   * <warn>Ceci est seulement utilisable avec un compte utilisateur.</warn>
